            ...
            <div class="col-lg-9 col-xl-8">
                ...
                <div class="columnist-card p-4 mb-4 shadow-sm rounded-4">
                    <div class="d-flex align-items-center gap-4">
                        <div class="position-relative">
                            ...
                            <?php } else { ?>
                                <div class="bg-warning text-dark rounded-circle d-flex align-items-center justify-content-center fw-bold fs-3 border border-3 border-white shadow"
                                    style="width: 80px; height: 80px;">
                                    <?= strtoupper(substr($article['author_name'], 0, 1)) ?>
                                </div>
                            <?php } ?>
                            <span
                                class="position-absolute bottom-0 end-0 badge rounded-pill bg-danger text-white border border-white">
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-2 mb-1">
                                <span
                                    class="badge bg-warning text-dark text-uppercase font-monospace text-xs fw-bold"><?= __('opinion_perspective') ?></span>
                ...
                <div
                    ...
                    <span><i class="bi bi-clock me-1 text-warning"></i>
                        <?= $article['reading_time'] ?? __('min_read', ['min' => 5]) ?></span>
                    <span>&bull;</span>
                    <span><i class="bi bi-eye me-1 text-primary"></i>
                ...
                <div class="opinion-quote">
                    &ldquo;Groundbreaking progress demands human courage and serendipity over pure algorithmic
                    aggregation.&rdquo;
                </div>
                ...
                <?php if (!empty($galleryUrls)) { ?>
                    <div class="my-4">
                        ...
                        <div id="galleryCarouselOp" class="carousel slide shadow-sm rounded-4 overflow-hidden"
                            ...
                            <button class="carousel-control-prev" type="button" data-bs-target="#galleryCarouselOp"
                                data-bs-slide="prev">
                                <span class="carousel-control-prev-icon"></span>
                                <span class="visually-hidden">Previous</span>
                            </button>
                            <button class="carousel-control-next" type="button" data-bs-target="#galleryCarouselOp"
                                data-bs-slide="next">
                ...
                <div class="columnist-card p-4 my-5 shadow-sm rounded-4 text-center">
                    <h5 class="editorial-title fw-bold text-dark mb-2">
                        <?= str_replace(':name', e($article['author_name']), __('about_columnist')) ?></h5>
