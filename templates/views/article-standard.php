    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb small">
                <li class="breadcrumb-item"><a href="<?= url('index.php') ?>" class="text-secondary text-decoration-none"><i class="bi bi-house-door me-1"></i>Home</a></li>
                ...
                <li class="breadcrumb-item active text-truncate" style="max-width: 320px;"><?= e(article_title($article['title'])) ?></li>
            </ol>
        </nav>
            ...
            <div class="col-lg-8">
                <article>
                    ...
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <span class="badge bg-danger text-uppercase px-2.5 py-1 fw-bold"><?= e(cat_name($article['category_name'])) ?></span>
                    ...
                    <!-- Summary Paragraph -->
                    <p class="lead text-secondary fw-normal fs-5 mb-4 border-start border-4 border-danger ps-3 py-2 bg-light rounded-end">
                        <?= e($article['summary']) ?>
                    </p>

                    <!-- Author & Published Metadata Bar -->
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 p-3 bg-white rounded-4 border mb-4 shadow-sm">
                        <div class="d-flex align-items-center gap-3">
                            <div class="bg-danger text-white rounded-circle d-flex align-items-center justify-content-center fw-bold fs-5 shadow-sm" style="width: 44px; height: 44px;">
                        ...
                        <div class="text-md-end text-muted small">
                            <div><i class="bi bi-clock me-1 text-danger"></i> <?= str_replace(':date', \App\Core\TemplateEngine::formatDate($article['published_at']), __('published_date')) ?></div>
                            <div class="text-xs text-secondary mt-1"><i class="bi bi-eye me-1"></i> <?= str_replace(':count', number_format((int)$article['views_count']), __('total_readers')) ?></div>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($article['featured_image'])) { ?>
                        <div class="mb-4 rounded-4 overflow-hidden shadow-sm">
                            <img src="<?= e($article['featured_image']) ?>" class="w-100 h-auto object-fit-cover" alt="<?= e($article['title']) ?>" style="max-height: 480px;">
                        </div>
                    <?php } ?>
                    ...
                    <?php if (!empty($galleryUrls)) { ?>
                        <div class="my-4">
                            ...
                            <div id="galleryCarouselStd" class="carousel slide shadow-sm rounded-4 overflow-hidden" data-bs-ride="carousel">
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 border-0 shadow-sm rounded-4 hover-lift">
                                    <div class="card-body p-3.5 d-flex flex-column justify-content-between">
                                        <div>
                                            <span class="badge bg-light text-dark border mb-2 text-xs"><?= e(cat_name($rItem['category_name'])) ?></span>
